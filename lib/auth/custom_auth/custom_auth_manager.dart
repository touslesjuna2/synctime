...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    synctimeAuthUserSubject.add(
      SynctimeAuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<SynctimeAuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  SynctimeAuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = SynctimeAuthUser(
      loggedIn: true,
      uid: authUid,
    );
    synctimeAuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
