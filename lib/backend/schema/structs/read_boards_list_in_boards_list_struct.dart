...
class ReadBoardsListInBoardsListStruct extends BaseStruct {
  ReadBoardsListInBoardsListStruct({
    int? id,
    int? univId,
    String? name,
    String? description,
  ...
  List<int>? _notificationPosts;
  List<int> get notificationPosts => _notificationPosts ?? const [];
  set notificationPosts(List<int>? val) => _notificationPosts = val;

  void updateNotificationPosts(Function(List<int>) updateFn) {
    updateFn(_notificationPosts ??= []);
  }
  ...
  static ReadBoardsListInBoardsListStruct fromMap(Map<String, dynamic> data) =>
      ReadBoardsListInBoardsListStruct(
        ...
        notificationPosts: getDataList(data['notification_posts']),
        isDeleted: data['is_deleted'] as bool?,
        rules: data['rules'] as String?,
        isManager: data['is_manager'] as bool?,
      );

  static ReadBoardsListInBoardsListStruct? maybeFromMap(dynamic data) => data
          is Map
      ? ReadBoardsListInBoardsListStruct.fromMap(data.cast<String, dynamic>())
      : null;
  ...
  static ReadBoardsListInBoardsListStruct fromSerializableMap(
      ...
      ReadBoardsListInBoardsListStruct(
        ...
        notificationPosts: deserializeParam<int>(
  ...
  @override
  String toString() => 'ReadBoardsListInBoardsListStruct(${toMap()})';

  @override
  bool operator ==(Object other) {
    const listEquality = ListEquality();
    return other is ReadBoardsListInBoardsListStruct &&
        id == other.id &&
        univId == other.univId &&
        name == other.name &&
        ...
        listEquality.equals(notificationPosts, other.notificationPosts) &&
...
ReadBoardsListInBoardsListStruct createReadBoardsListInBoardsListStruct({
  int? id,
  int? univId,
  String? name,
  String? description,
