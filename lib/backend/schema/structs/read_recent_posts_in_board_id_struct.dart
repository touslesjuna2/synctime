...
class ReadRecentPostsInBoardIdStruct extends BaseStruct {
  ReadRecentPostsInBoardIdStruct({
    int? id,
    int? univId,
    int? boardId,
  ...
  static ReadRecentPostsInBoardIdStruct fromMap(Map<String, dynamic> data) =>
      ReadRecentPostsInBoardIdStruct(
  ...
  static ReadRecentPostsInBoardIdStruct? maybeFromMap(dynamic data) =>
      data is Map
          ? ReadRecentPostsInBoardIdStruct.fromMap(data.cast<String, dynamic>())
          : null;
  ...
  static ReadRecentPostsInBoardIdStruct fromSerializableMap(
  ...
  @override
  String toString() => 'ReadRecentPostsInBoardIdStruct(${toMap()})';

  @override
  bool operator ==(Object other) {
    const listEquality = ListEquality();
    return other is ReadRecentPostsInBoardIdStruct &&
        id == other.id &&
        univId == other.univId &&
...
ReadRecentPostsInBoardIdStruct createReadRecentPostsInBoardIdStruct({
  int? id,
  int? univId,
  int? boardId,
  UserBoardProfileStruct? userBoardProfile,
