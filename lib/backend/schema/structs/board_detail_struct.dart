...
class BoardDetailStruct extends BaseStruct {
  BoardDetailStruct({
    int? id,
    int? univId,
    String? name,
  ...
  static BoardDetailStruct fromMap(Map<String, dynamic> data) =>
      BoardDetailStruct(
  ...
  static BoardDetailStruct? maybeFromMap(dynamic data) => data is Map
      ? BoardDetailStruct.fromMap(data.cast<String, dynamic>())
      : null;
  ...
  static BoardDetailStruct fromSerializableMap(Map<String, dynamic> data) =>
      BoardDetailStruct(
        id: deserializeParam(
          data['id'],
          ParamType.int,
  ...
  @override
  String toString() => 'BoardDetailStruct(${toMap()})';

  @override
  bool operator ==(Object other) {
    const listEquality = ListEquality();
    return other is BoardDetailStruct &&
        id == other.id &&
        univId == other.univId &&
        name == other.name &&
...
BoardDetailStruct createBoardDetailStruct({
  int? id,
  int? univId,
  String? name,
  String? description,
