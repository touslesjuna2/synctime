...
import 'd1_email_school_model.dart';
export 'd1_email_school_model.dart';

class D1EmailSchoolWidget extends StatefulWidget {
  const D1EmailSchoolWidget({super.key});

  @override
  State<D1EmailSchoolWidget> createState() => _D1EmailSchoolWidgetState();
}

class _D1EmailSchoolWidgetState extends State<D1EmailSchoolWidget>
    with TickerProviderStateMixin {
  late D1EmailSchoolModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => D1EmailSchoolModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'd1_Email_school'});
...
(immediate) */
                                ...
                                children: [
                                  ...
                                  FutureBuilder<ApiCallResponse>(
                                    ...
                                    builder: (context, snapshot) {
                                      ...
                                      final iconButtonRegisterRequestLoginIDVerificationResponse =
                                          snapshot.data!;
                              ...
                              Padding(
                                ...
                                child: FFButtonWidget(
                                  onPressed: () async {
                                    logFirebaseEvent(
                                        'D1_EMAIL_SCHOOL_PAGE_NEXT_BTN_ON_TAP');
                                    logFirebaseEvent('Button_navigate_to');

                                    context
                                        .pushNamed('e1_Verification_complete');
                                  },
