...
import 'change_profile_image_model.dart';
export 'change_profile_image_model.dart';
...
class _ChangeProfileImageWidgetState extends State<ChangeProfileImageWidget> {
  late ChangeProfileImageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ChangeProfileImageModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'Change_Profile_Image'});
        ...
        appBar: AppBar(
          ...
          leading: Padding(
            ...
            child: FlutterFlowIconButton(
              ...
              onPressed: () async {
                logFirebaseEvent('CHANGE_PROFILE_IMAGE_arrow_back_ICN_ON_T');
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        FFButtonWidget(
                                          onPressed: () async {
                                            logFirebaseEvent(
                                                'CHANGE_PROFILE_IMAGE_UPLOAD_IMAGE_BTN_ON');
                                            logFirebaseEvent(
                                        ...
                                        FFButtonWidget(
                                          onPressed: () async {
                                            logFirebaseEvent(
                                                'CHANGE_PROFILE_IMAGE_SAVE_CHANGES_BTN_ON');
                                            logFirebaseEvent(
                                                'Button_navigate_back');
                                            context.pop();
                                          },
