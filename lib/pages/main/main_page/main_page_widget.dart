            ...
            children: [
              ...
              FutureBuilder<ApiCallResponse>(
                ...
                builder: (context, snapshot) {
                  ...
                  final conditionalBuilderUnividBoardResponse = snapshot.data!;

                  return Builder(
                    builder: (context) {
                      if (conditionalBuilderUnividBoardResponse.bodyText ==
                        ...
                        return FutureBuilder<ApiCallResponse>(
                          ...
                          builder: (context, snapshot) {
                            ...
                            final listViewUnividBoardResponse = snapshot.data!;

                            return Builder(
                              builder: (context) {
                                final board = listViewUnividBoardResponse
                                    .jsonBody
                                    .toList();
